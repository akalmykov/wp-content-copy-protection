<div class="wrap">
	...
	font-family: Arial;
			...
			<font size="3">√ Admin can enable/disable protection for site admins only OR admin and registered/logged in users</font><br />
			<font size="3">√ Aggressive image protection (masking ability makes is near impossible for users to steal your images | pc and mobile friendly)</font><br />
			<font size="3">√ Compatible with gallery plugins (such as NextGEN and NextCellent) for uncompromised image protection</font><br />
			<font size="3">√ Removes feeds (rdf, rss, rss2, atom, rss2_comments and more) from content scrapers and autoblogs</font><br />
			<font size="3">√ Includes extended keyboard copy protection commands (Windows, Linux and Mac OS X compatible)</font><br />
			<font size="3">√ Includes a Prt Sc (Print Screen) deterrent agent (preventative measure in image theft)</font><br />
			<font size="3">√ Includes extended CSS text and image protection for mobile devices and smartphones</font><br />
			<font size="3">√ Source code view is disabled from F12, Ctrl+Shift+I, Ctrl+U and other combo keys</font><br />
